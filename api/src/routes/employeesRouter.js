...
const { loginByEmail,postEmployees, getEmployees, deleteEmployees, putEmployees, getEmployeeByNumber, getEmployeeByEmail } = require('../controllers/employeesController.js');
...
employeesRouter.get('/number/:number',getEmployeeByNumber);
