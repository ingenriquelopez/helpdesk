...
const { postTraining_Employee, getTraining_Employee, getEmployees_Of_Training,putEmployees_Of_Training } = require('../controllers/training_employees_Controller.js');
...
training_employeesRouter.put('/'    ,putEmployees_Of_Training);
